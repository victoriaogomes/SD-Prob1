...
`timescale 1 ps / 1 ps
module arqte1_mm_interconnect_0 (
	...
	wire  [15:0] saida_s1_agent_m0_address;                                                          // saida_s1_agent:m0_address -> saida_s1_translator:uav_address
	...
	wire  [92:0] saida_s1_agent_rf_source_data;                                                      // saida_s1_agent:rf_source_data -> saida_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] saida_s1_agent_rsp_fifo_out_data;                                                   // saida_s1_agent_rsp_fifo:out_data -> saida_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> saida_s1_agent:cp_valid
	wire  [91:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> saida_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // saida_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> saida_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> saida_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> saida_s1_agent:cp_endofpacket
	...
	wire  [15:0] memoria_s1_agent_m0_address;                                                        // memoria_s1_agent:m0_address -> memoria_s1_translator:uav_address
	...
	wire  [91:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> memoria_s1_agent:cp_data
	...
	wire  [15:0] entrada_s1_agent_m0_address;                                                        // entrada_s1_agent:m0_address -> entrada_s1_translator:uav_address
	...
	wire  [92:0] entrada_s1_agent_rf_source_data;                                                    // entrada_s1_agent:rf_source_data -> entrada_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] entrada_s1_agent_rsp_fifo_out_data;                                                 // entrada_s1_agent_rsp_fifo:out_data -> entrada_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> entrada_s1_agent:cp_valid
	wire  [91:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> entrada_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // entrada_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> entrada_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> entrada_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> entrada_s1_agent:cp_endofpacket
	...
	wire         saida_s1_agent_rp_valid;                                                            // saida_s1_agent:rp_valid -> router_005:sink_valid
	wire  [91:0] saida_s1_agent_rp_data;                                                             // saida_s1_agent:rp_data -> router_005:sink_data
	wire         saida_s1_agent_rp_ready;                                                            // router_005:sink_ready -> saida_s1_agent:rp_ready
	wire         saida_s1_agent_rp_startofpacket;                                                    // saida_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         saida_s1_agent_rp_endofpacket;                                                      // saida_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [91:0] memoria_s1_agent_rp_data;                                                           // memoria_s1_agent:rp_data -> router_006:sink_data
	...
	wire         entrada_s1_agent_rp_valid;                                                          // entrada_s1_agent:rp_valid -> router_007:sink_valid
	wire  [91:0] entrada_s1_agent_rp_data;                                                           // entrada_s1_agent:rp_data -> router_007:sink_data
	wire         entrada_s1_agent_rp_ready;                                                          // router_007:sink_ready -> entrada_s1_agent:rp_ready
	wire         entrada_s1_agent_rp_startofpacket;                                                  // entrada_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         entrada_s1_agent_rp_endofpacket;                                                    // entrada_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         saida_s1_agent_rdata_fifo_src_valid;                                                // saida_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] saida_s1_agent_rdata_fifo_src_data;                                                 // saida_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         saida_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_003:in_0_ready -> saida_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> saida_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> saida_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // saida_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> saida_s1_agent:rdata_fifo_sink_error
	...
	wire         entrada_s1_agent_rdata_fifo_src_valid;                                              // entrada_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] entrada_s1_agent_rdata_fifo_src_data;                                               // entrada_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         entrada_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_005:in_0_ready -> entrada_s1_agent:rdata_fifo_src_ready
	...
	arqte1_mm_interconnect_0_router router (
	...
	arqte1_mm_interconnect_0_router_001 router_001 (
	...
	arqte1_mm_interconnect_0_router_002 router_002 (
	...
	arqte1_mm_interconnect_0_router_002 router_003 (
	...
	arqte1_mm_interconnect_0_router_004 router_004 (
	...
	arqte1_mm_interconnect_0_router_002 router_005 (
	...
	arqte1_mm_interconnect_0_router_004 router_006 (
	...
	arqte1_mm_interconnect_0_router_002 router_007 (
	...
	arqte1_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	arqte1_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	arqte1_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (saida_s1_agent_rdata_fifo_src_data),             //     in_0.data
		.in_0_valid     (saida_s1_agent_rdata_fifo_src_valid),            //         .valid
		.in_0_ready     (saida_s1_agent_rdata_fifo_src_ready),            //         .ready
	...
	arqte1_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (entrada_s1_agent_rdata_fifo_src_data),           //     in_0.data
		.in_0_valid     (entrada_s1_agent_rdata_fifo_src_valid),          //         .valid
		.in_0_ready     (entrada_s1_agent_rdata_fifo_src_ready),          //         .ready
